...
Custom domains are configured through Netlify. See [Netlify's custom domain documentation](https://docs.netlify.com/domains-https/custom-domains/) for setup instructions.
