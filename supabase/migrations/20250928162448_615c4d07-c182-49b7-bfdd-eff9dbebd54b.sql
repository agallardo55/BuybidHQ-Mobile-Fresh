-- Update get_public_bid_request_details function to include vehicle colors and accessories
...
BEGIN
  ...
  -- Return sanitized bid request details for this specific token including colors and accessories
  RETURN QUERY
  SELECT 
    br.id as request_id,
    br.created_at,
