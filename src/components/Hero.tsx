          ...
          <div className="w-full mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center lg:pt-32">
            <div className="mx-auto max-w-3xl">
              <div className="animate-fade-in">
                <span className="rounded-full bg-white/20 px-3 py-1 text-sm font-semibold leading-6 text-white ring-1 ring-inset ring-white/40 backdrop-blur-[2px]">Built to scale more deals.</span>
              </div>
              ...
              animationDelay: "0.4s"
                ...
                <Button className="bg-[#325AE7] hover:bg-[#325AE7]/70 text-lg px-8 py-6 w-full sm:w-auto shadow-lg transition-colors duration-200" onClick={scrollToPricing}>
                  Get Started
