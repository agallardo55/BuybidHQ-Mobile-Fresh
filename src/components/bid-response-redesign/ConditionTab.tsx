  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <Card className="p-4 sm:p-6 rounded-2xl">
        ...
        <div className="bg-green-100 rounded-xl p-3 sm:p-4 mb-4 flex items-center justify-between">
          <p className="text-xs font-bold text-green-800 uppercase tracking-wide">Estimated Recon Cost</p>
