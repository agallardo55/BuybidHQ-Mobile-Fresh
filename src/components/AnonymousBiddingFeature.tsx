...
const AnonymousBiddingFeature = () => {
  const features = [{
    ...
    description: "Skip the back-and-forth haggling - simply set your terms and wait for the right match."
  }, {
  ...
  return <section className="py-24 bg-white">
      <div className="container px-4 md:px-6">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">Our innovative platform allows you to end and recieved offers without revealing your identity, connecting only when a deal is ready to close.</p>
        </div>
