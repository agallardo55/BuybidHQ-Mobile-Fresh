      ...
      <TableCell className="py-2 px-4 h-[44px] whitespace-nowrap" onClick={(e) => e.stopPropagation()}>
        ...
        >
          <SelectTrigger className={`w-[90px] h-6 text-sm font-medium
            ...
            ${currentStatus.toLowerCase() === 'pending' ? 'bg-blue-100 text-blue-800 border-blue-200 hover:bg-blue-200' : ''}
            ${currentStatus.toLowerCase() === 'declined' ? 'bg-gray-100 text-gray-800 border-gray-200 hover:bg-gray-200' : ''}
          `}>
            <SelectValue>{capitalizeFirstLetter(currentStatus)}</SelectValue>
          </SelectTrigger>
          <SelectContent>
            <SelectItem value="pending" className="bg-blue-100 text-blue-800 data-[highlighted]:!bg-blue-500 data-[highlighted]:!text-white focus:!bg-blue-500 focus:!text-white">Pending</SelectItem>
            <SelectItem value="accepted" className="bg-green-100 text-green-800 data-[highlighted]:!bg-green-600 data-[highlighted]:!text-white focus:!bg-green-600 focus:!text-white">Accepted</SelectItem>
            <SelectItem value="declined" className="bg-gray-100 text-gray-800 data-[highlighted]:!bg-gray-500 data-[highlighted]:!text-white focus:!bg-gray-500 focus:!text-white">Not Selected</SelectItem>
          </SelectContent>
        </Select>
      </TableCell>
    </UITableRow>
