    ...
    <div className="space-y-3">
      <div className="relative">
        ...
        <Input
          ...
          className="pl-10 focus:outline-none focus-visible:!ring-0 focus-visible:!ring-offset-0 focus:!ring-0 focus:!ring-offset-0 focus:!border-blue-600 focus-visible:!border-blue-600"
        />
      </div>
